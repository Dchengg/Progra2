                    ...
                    public boolean onNavigationItemSelected(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.nav_inicio1:
                                startActivity(new Intent(ConsultarDatosActivity.this, PCursoActivity.class));
                                break;
                            case R.id.nav_reporteNotas:
                                startActivity(new Intent(ConsultarDatosActivity.this, ConsultarNotasFinales.class));
                                break;
                            case R.id.nav_asignarNota:
                                startActivity(new Intent(ConsultarDatosActivity.this, AsignarNotaProfCursoActivity.class));
                                break;
                            case R.id.nav_log_out:
                                startActivity(new Intent(ConsultarDatosActivity.this, LogInActivity.class));
                                break;
                        }
                        return true;
                    }
